...
export default function Projects() {
  ...
  return (
    <>
      <Seo title="Projects — ArkNova Construction Portfolio" description="Explore ArkNova's portfolio of residential, luxury, commercial, educational, hospitality and infrastructure projects across Ghana." />
      <PageHero
        eyebrow="— Portfolio"
