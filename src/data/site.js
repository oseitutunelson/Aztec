...
export const PROJECTS = [
  ...
  {
    slug: 'the-nhyira-residence',
    name: 'The Nhyira Residence',
    category: 'Modern Homes',
    year: '2026',
    location: 'Tema, Greater Accra',
    cover: 'nhyira-1.jpeg',
    blurb:
      'An elegant bungalow crowned with a deep charcoal stone-coated hip roof, framed by a natural stone feature pillar, wrought-iron window screens and a wide marble step entrance.',
    scope: ['Architectural Design', 'Construction', 'Roofing', 'Interior Finishing'],
    size: '380 m²',
    duration: 'In progress',
    budget: 'GH₵ 2.4M',
    gallery: ['nhyira-1.jpeg', 'nhyira-2.jpeg'],
    challenge: 'Balancing a stately multi-hip roofline with an open, light-filled portico across a wide single-storey footprint.',
    solution: 'A precision-framed hip roof with deep ventilated eaves, paired with a stone-clad pillar and layered entrance steps, gives the home presence from every approach.',
    status: 'Finishing Phase',
    featured: true,
  },
  {
    slug: 'the-anidaso-estate',
    name: 'The Anidaso Estate',
    category: 'Residential Estates',
    year: '2026',
    location: 'Dawhenya, Greater Accra',
    cover: 'anidaso-1.jpeg',
    blurb:
      'A fully walled estate of matching family bungalows with charcoal stone-coated roofs, timber-trimmed eaves and paved internal streets — delivered as one coordinated build.',
    scope: ['Architectural Design', 'Turnkey Construction', 'Exterior Works', 'Site Supervision'],
    size: '1,600 m² (multi-unit)',
    duration: 'In progress',
    budget: 'GH₵ 7.2M',
    gallery: ['anidaso-1.jpeg', 'anidaso-2.jpeg', 'anidaso-3.jpeg', 'anidaso-4.jpeg', 'anidaso-5.jpeg'],
    challenge: 'Sequencing several identical units, boundary walls and internal paving so every home reaches finishing stage together.',
    solution: 'A repeatable unit module, staged roofing and a shared services corridor keep quality consistent and the whole compound on one timeline.',
